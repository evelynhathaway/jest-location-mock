...
describe("window.history", () => {
	describe("replaceState()", () => {
		it("should update location mock", () => {
			...
			expect(window.location.pathname).toEqual("/0e37bca8-b8e3-49ee-8ac6-57e50c2884d3");
		});
	});
	...
	describe("pushState()", () => {
		it("should update location mock", () => {
			...
			expect(window.location.pathname).toEqual("/e8bf1e04-46e9-4f30-abcb-320412243ea2");
		});
	});
	...
	describe.skip("history", () => {
		describe("go()", () => {
			it("should update location mock", () => {
				...
				expect(window.location.pathname).toEqual("/04d333bd-4694-49be-aa25-d7e92515eabb");
				window.history.pushState(null, "", "/ca1ed895-b590-421e-be9b-84ef2a5aa5fd");
				expect(window.location.pathname).toEqual("/ca1ed895-b590-421e-be9b-84ef2a5aa5fd");
				window.history.go(-1);
				expect(window.location.pathname).toEqual("/04d333bd-4694-49be-aa25-d7e92515eabb");
				window.history.go(-1);
				expect(window.location.pathname).toEqual("/");
		...
		describe("back() and forward()", () => {
			it("should update location mock", () => {
				...
				expect(window.location.pathname).toEqual("/9330c6b2-153d-411f-ac67-8adb74b614f0");
				window.history.back();
				expect(window.location.pathname).toEqual("/");
